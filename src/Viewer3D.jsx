...
  /* ================== Setup escena ================== */
  useEffect(() => {
    // --- Setup de Escena, Cámara, Renderer, Toast, Entorno, Controles, Luces ---
...
    // Ya no escuchamos a 'window.resize', sino al 'mount' (el div contenedor).
    const handleResize = () => {
      const mount = mountRef.current;
...
      // Si el div está oculto (0x0), no hacemos nada.
      // Esto evita errores en el primer renderizado en móvil.
      if (w2 === 0 || h2 === 0) return;
...
    // Creamos el observador y lo conectamos al div 'mount'
    const resizeObserver = new ResizeObserver(handleResize);
    resizeObserver.observe(mount);
    
    // Hacemos una llamada inicial por si acaso
    handleResize();
    // ==============================================
...
      // --- Cleanup ---
      
      // CORRECCIÓN: Desconectar el observador
